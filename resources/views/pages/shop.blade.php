            ...
            <div class="row g-4">
                <div class="col-lg-6 wow fadeInLeft" data-wow-delay="0.2s">
                    <a href="#" class="d-flex align-items-center justify-content-between border bg-white rounded p-4">
                        <div>
                            <p class="text-muted mb-3">Find The Best Auto Care Products for You</p>
                            <h3 class="text-primary">Auto Care Products</h3>
                            <h1 class="display-3 text-secondary mb-0">40% <span
                                    class="text-primary fw-normal">Off</span></h1>
                        </div>
                        <img src="img/auto-care-products.png" class="img-fluid" alt="">
                    </a>
                </div>
                <div class="col-lg-6 wow fadeInRight" data-wow-delay="0.3s">
                    <a href="#" class="d-flex align-items-center justify-content-between border bg-white rounded p-4">
                        <div>
                            <p class="text-muted mb-3">Find The Best Engine Oil for You</p>
                            <h3 class="text-primary">Engine Oil</h3>
                            <h1 class="display-3 text-secondary mb-0">20% <span
                                    class="text-primary fw-normal">Off</span></h1>
                        </div>
                        <img src="img/engine-oil-and-other-fluids.png" class="img-fluid" alt="">
                    </a>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-3 wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <ul class="list-unstyled">
                            <li>
                                <div class="categories-item">
                                    <a href="#" class="text-dark"><i class="fas fa-car text-secondary me-2"></i>
                                        Break Parts</a>
                                    <span>(3)</span>
                                </div>
                            </li>
                            ...
                            <li>
                                <div class="categories-item">
                                    <a href="#" class="text-dark"><i
                                            class="fas fa-car text-secondary me-2"></i>Engine Parts</a>
                                    <span>(2)</span>
                                </div>
                            </li>
                            <li>
                                <div class="categories-item">
                                    <a href="#" class="text-dark"><i
                                            class="fas fa-car text-secondary me-2"></i>Engine Oil And Other Fluids</a>
                                    <span>(8)</span>
                                </div>
                            </li>
                            <li>
                                <div class="categories-item">
                                    <a href="#" class="text-dark"><i
                                            class="fas fa-car text-secondary me-2"></i>Filters</a>
                                    <span>(5)</span>
                                </div>
                            </li>
                            <li>
                                <div class="categories-item">
                                    <a href="#" class="text-dark"><i
                                            class="fas fa-car text-secondary me-2"></i>Auto Care Products</a>
                                    <span>(5)</span>
                                </div>
                            </li>
                        </ul>
                    ...
                    <div class="additional-product mb-4">
                        ...
                        <div class="additional-product-item">
                            ...
                            <label for="Categories-1" class="text-dark"> Engine Oil</label>
                        </div>
                        <div class="additional-product-item">
                            <input type="radio" class="me-2" id="Categories-2" name="Categories-1" value="Beverages">
                            <label for="Categories-2" class="text-dark"> Tires</label>
                        </div>
                        <div class="additional-product-item">
                            <input type="radio" class="me-2" id="Categories-3" name="Categories-1" value="Beverages">
                            <label for="Categories-3" class="text-dark"> Fuel Pump</label>
                        </div>
                        <div class="additional-product-item">
                            <input type="radio" class="me-2" id="Categories-4" name="Categories-1" value="Beverages">
                            <label for="Categories-4" class="text-dark"> Brake Fluid</label>
                        </div>
                        <div class="additional-product-item">
                            <input type="radio" class="me-2" id="Categories-5" name="Categories-1" value="Beverages">
                            <label for="Categories-5" class="text-dark"> Control Arm</label>
                        </div>
                    </div>
                    ...
                    <a href="#">
                        <div class="position-relative">
                            <img src="img/break-parts.png" class="img-fluid w-100 rounded" alt="Image">
                    ...
                    <div class="product-tags py-4">
                        ...
                        <div class="product-tags-items bg-light rounded p-3">
                            ...
                            <a href="#" class="border rounded py-1 px-2 mb-2">oil</a>
                            <a href="#" class="border rounded py-1 px-2 mb-2">engine</a>
                            <a href="#" class="border rounded py-1 px-2 mb-2">brake</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-9 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="rounded mb-4 position-relative">
                        <img src="img/automobile-motor-parts-banner-engine-tire-brake-gear.png" class="img-fluid rounded w-100" style="height: 250px;"
                            alt="Image">
                                    ...
                                    <div class="product-item rounded wow fadeInUp" data-wow-delay="0.1s">
                                        <div class="product-item-inner border rounded">
                                            <div class="product-item-inner-item">
                                                <img src="{{ Storage::url($product->main_image) }}" class="img-fluid w-100 rounded-top" alt="{{ $product->name }}">
                                                <div class="product-new">{{ $product->condition }}</div>
                                        ...
                                        <div class="row g-0">
                                            <div class="col-5">
                                                <div class="products-mini-img border-end h-100">
                                                    <img src="{{ Storage::url($product->main_image) }}" class="img-fluid w-100 h-100"
                                                        alt="{{ $product->name }}">
                ...
                <div class="col-lg-6 wow fadeInLeft" data-wow-delay="0.1s">
                    <a href="#">
                        <div class="bg-primary rounded position-relative">
                            <img src="img/motor-tire-2.png" class="img-fluid w-100 rounded" alt="">
                ...
                <div class="col-lg-6 wow fadeInRight" data-wow-delay="0.2s">
                    <a href="#">
                        <div class="text-center bg-primary rounded position-relative">
                            <img src="img/motor-engine-2.png" class="img-fluid w-100" alt="">
                            <div class="position-absolute top-0 start-0 w-100 h-100 d-flex flex-column justify-content-center rounded p-4"
