...
<head>
    <meta charset="utf-8">
    <title>@yield('title') :: WizzyAutos - Your Original Motor Parts</title>
        ...
        <div class="row gx-0 align-items-center text-center">
            ...
            <!-- <div class="col-md-4 col-lg-3 text-center text-lg-end">
                <div class="d-inline-flex align-items-center">
                    ...
                    <a href="#" class="text-muted d-flex align-items-center justify-content-center me-3">
                        <span
                            class="rounded-circle btn-md-square border"><i class="fas fa-heart"></i>
                        </span>
                    </a>

                    <a href="#" class="text-muted d-flex align-items-center justify-content-center">
                        <span class="rounded-circle btn-md-square border"><i class="fas fa-shopping-cart"></i>
                        </span>
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-primary ">
                    <a href="" class="navbar-brand d-block d-lg-none">
                        <h1 class="display-5 text-secondary m-0"><i
                                class="fas fa-car text-white me-2"></i>WizzyAutos</h1>
                        <!-- <img src="img/logo.png" alt="Logo"> -->
                    </a>
