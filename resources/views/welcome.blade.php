...
<head>
    <meta charset="utf-8">
    <title>WizzyAutos - Your Original Motor Parts</title>
                ...
                <div class="d-inline-flex align-items-center">
                    <a href="" class="navbar-brand p-0">
                        <h1 class="display-5 text-primary m-0"><i
                                class="fas fa-car text-secondary me-2"></i>WizzyAutos</h1>
                ...
                <div class="position-relative ps-4">
                    <div class="d-flex border rounded-pill">
                        <input class="form-control border-0 rounded-pill w-100 py-3" type="text"
                            data-bs-target="#dropdownToggle123" placeholder="What are you looking for?">
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-primary ">
                    <a href="" class="navbar-brand d-block d-lg-none">
                        <h1 class="display-5 text-secondary m-0"><i
                                class="fas fa-shopping-bag text-white me-2"></i>WizzyAutos</h1>
                        <!-- <img src="img/logo.png" alt="Logo"> -->
                    </a>
                ...
                <div class="carousel-header-banner h-100">
                    ...
                    <div class="carousel-banner">
                        <div class="carousel-banner-content text-center p-4">
                            ...
                            <a href="#" class="d-block text-white fs-3">Affordable, Durable, Reliable  <br> WizzyAutos</a>
                            <span class="me-2 text-white fs-5">Trusted</span>
                            <span class="text-primary fs-5">Auto Parts</span>
                        </div>
                        <a href="#" class="btn btn-primary rounded-pill py-2 px-4"><i
                                class=" me-2"></i> Shop Here</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-6 col-lg-6 col-xl-3">
                    <div class="rounded p-4">
                        ...
                        <div>
                            ...
                            <p class="mb-2">Abobo route zoo CIE</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-6 col-xl-3">
                    <div class="rounded p-4">
                        ...
                        <div>
                            ...
                            <p class="mb-2">support@wizzyautos.com</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-6 col-xl-3">
                ...
                <div class="col-md-6 col-lg-6 col-xl-3">
                    <div class="footer-item d-flex flex-column">
                        <div class="footer-item">
                            ...
                            <p class="mb-3">Stay ahead with the latest auto parts deals, new arrivals, and expert car care tips. Subscribe to our newsletter and never miss out on exclusive offers from WizzyAutos.</p>
            ...
            <div class="row g-4 align-items-center">
                <div class="col-md-6 text-center text-md-start mb-md-0">
                    <span class="text-white"><a href="#" class="border-bottom text-white"><i
                                class="fas fa-copyright text-light me-2"></i>WizzyAutos</a>, All right
                        reserved.</span>
                </div>
                <div class="col-md-6 text-center text-md-end text-white">


                    <!-- Designed By <a class="border-bottom text-white" href="">Solomon</a>. -->
                </div>
            </div>
        </div>
    </div>
